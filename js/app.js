(function(){
    ...
    document.getElementById('customer-form').addEventListener('submit', function(event){
        ...
        //console.log(this); --- gives customer-form objecct
    ...
    Display.prototype.feedback=function(customer){
        ...
        const self = this;
        //console.log(self); --- gives Display constructor
        self.hideSubmit();
 
        setTimeout(function(){
            feedback.classList.remove('showItem', 'alert', 'alert-success');
            loading.classList.remove('showItem');
            //console.log(this);--Gives window object since setTimeout is global function...hence using self instead of this
